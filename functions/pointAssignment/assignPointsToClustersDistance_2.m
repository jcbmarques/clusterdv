...
%1) assigns data points to clusters - closest points to density center in order
 ...
 function [clusterAssignment] = assignPointsToClustersDistance_2(data,indClusterCenters,rho,makeplot)
   
%  indClusterCenters=thisClusterCentersInd;
...
for n = 1  : length(rhoSorted)%loop through every point by density
     ...
     clusterAssignmentSorted(n) = clusterAssignmentSorted(indAssignedPoints); 
