function   [densityLineMap]=fastDensityLinesCalc_3(thisdata,kdedens,rho,distfun,whichMethod,nsamps,doplot);
...
line([thisdata(n,1) thisdata(allUpConns(n),1)],...
    [thisdata(n,2) thisdata(allUpConns(n),2)],'LineWidth',5,'Color',[1 0 0])
end
end
...
%     [thisdata(linkageInfo.preLinks(n),2) thisdata(linkageInfo.postLinks(n),2)],'LineWidth',1, 'color','k')
% end
box off    
axis square  
axis off
